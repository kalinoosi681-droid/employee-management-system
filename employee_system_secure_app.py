#!/usr/bin/env python3
"""
EmployeeFlow — Secure Employee Management System (production-ready)
- Single-file CLI application using SQLite
- PBKDF2 password hashing for admin accounts
- Clean error handling, config override, CSV export, and modular helpers
- Designed for Termux / Linux / Windows (Python 3.8+)
Author: Kali Noosi
License: MIT
"""
